...
import me from "../assets/img/CV EduardHerák 2.jpg";
...
const AboutMe: React.FC = () => {
  ...
  const paragraphs =
    language === "SK" ? aboutMeData.paragraphs_SK : aboutMeData.paragraphs_EN;
        ...
        <div className="title-container flex flex-col gap-6 justify-center items-center p-32 w-1/2 max-lg:w-full max-lg:p-16 max-lg:items-start">
          ...
          >
            <p className="text-[--black] mb-6">
              ...
              {language === "SK" ? aboutMeData.title : aboutMeData.title_EN}
              <span className="text-orange">/&gt;</span>
            </p>
        ...
        <div className="flex flex-row justify-center gap-6 items-center pl-32 pr-32 mb-16  max-lg:flex-col max-lg:p-16 min-[1921px]:px-[45rem] min-[1921px]:mb-48">
          ...
          >
            {paragraphs.map((paragraph, index) => (
              <SwiperSlide
                className="bg-[--darkblue] text-[--white] flex flex-col justify-center items-start gap-24 rounded-2xl p-20 border-solid border-[0.4rem] border-[--lightblue] duration-500 transition-all text-left max-lg:p-10 cursor-grab"
                key={index}
              >
                ...
                <div className="flex flex-row gap-10 max-lg:flex-col">
                  <div className="flex flex-col gap-4 items-center justify-between -mt-10 -mb-10 max-lg:flex-row max-lg:m-0">
                    <p className="text-white">
                      <span className="text-orange">&lt;</span>h1
                      <span className="text-orange">/&gt;</span>
                    </p>
