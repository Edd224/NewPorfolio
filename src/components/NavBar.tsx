        ...
        <nav
          className={`max-lg:hidden flex-row flex justify-center items-center gap-24 font-semibold p-5 top-0 ${
            isSticky && !isMobileMenuActive
              ? `sticky top-0 z-50 ml-auto mr-auto rounded-lg w-max  px-16 py-5 transition-all ease-in-out duration-100  bg-opacity-50  shadow-black/[0.03] backdrop-blur-[0.3rem] ${
